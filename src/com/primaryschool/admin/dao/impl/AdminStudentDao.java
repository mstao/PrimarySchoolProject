...
public class AdminStudentDao<T> implements IAdminStudentDao<T> {
	...
	public boolean updateStudentInfo(T t) {
		// TODO Auto-generated method stub
		String hql="update Student u set u.itemTitle=:itemTitle ,u.itemContent=:itemContent,u.addTime=:addTime,u.isImage=:isImage,u.isPublish=:isPublish,u.author=:author  where u.id=:id";
		Query query  = sessionFactory.getCurrentSession().createQuery(hql); 

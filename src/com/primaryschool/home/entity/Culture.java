...
public class Culture implements Serializable{
    ...
    public Culture(int id,String itemTitle,Date addTime){
    	super();
    	this.id = id;
    ...
    public Culture(int id , String itemTitle,Date addTime,int viewCount){
    	super();
    	this.id = id;
		this.itemTitle = itemTitle;
		this.addTime = addTime;
    ...
    public Culture(int id, String itemTitle, String itemContent, Date addTime, int viewCount, 
	...
	public Culture(int id, String itemTitle, String itemTypeFlag,String imagePath) {
	 ...
	 public Culture(int id,String author, String itemTitle, String itemContent, Date addTime, int viewCount, 
	  ...
	  public Culture(int id,String itemTitle,Date addTime,int isPublish,String author){
	    	super();
	    	this.id = id;
			this.itemTitle = itemTitle;
			this.addTime = addTime;

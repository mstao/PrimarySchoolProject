...
public class Education implements Serializable{
    ...
    public Education(int id,String itemTitle,String addTime){
    	super();
    	this.id = id;
    ...
    public Education(int id , String itemTitle,String addTime,int viewCount){
    	super();
    	this.id = id;
		this.itemTitle = itemTitle;
		this.addTime = addTime;
    ...
    //图片轮播
	public Education(int id, String itemTitle, String itemContent, String addTime,String itemTypeFlag) {
		super();
		this.id = id;
		this.itemTitle = itemTitle;
		this.itemContent = itemContent;

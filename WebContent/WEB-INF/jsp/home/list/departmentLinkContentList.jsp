				...
				<div class="list-content">
					<ul>
					  <c:forEach items="${item}" var="trends_list">
						<li><span><img src="${CTP_HOME}/img/time.png" /> ${trends_list.addTime}</span><a href="${CTP}/details/${durl}?contentId=${trends_list.id}&departmentId=${trends_list.departmentId}&contentFlag=${trends_list.typeId}">${trends_list.itemTitle}</a></li>
					  </c:forEach>
					</ul>
				</div>
			...
			<div class="hot">
				...
				<c:forEach items="${hotItem}" var="hotTrends">
					<div class="hot-content">
						...
						<span class="hot-news-detail"><a href="${CTP}/details/${durl}?contentId=${hotTrends.id}&contentFlag=${hotTrends.typeId}&departmentId=${hotTrends.departmentId}">${hotTrends.itemTitle}</a></span>
					</div>
				</c:forEach>
			</div>

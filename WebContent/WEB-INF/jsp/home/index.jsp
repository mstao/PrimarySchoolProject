...
<body>
    ...
    <div class="content">
        ...
        <div class="content-div campus-trends">
            <div class="trends-top campus-trends-top">
                <img src="${CTP_HOME}/img/dongtai.png"/>
                <span class="tag-ch">校园动态</span>
                <span class="tag-en">Trends and Activities</span>
                <a class="link-tag" href="${CTP}/category/trends">进入>></a>
            </div>

            <!--S 校园动态内容-->
            <div class="campus-nav-tag">
                <span class="news-tag">校内新闻</span>
                <span class="jiantou"><img src="${CTP_HOME}/img/jiantou.png"/></span>
                <span class="notice-tag">通知公告</span>
                <span class="jiantou-notice"><img src="${CTP_HOME}/img/jiantou.png"/></span>
            </div>
            <!--S 轮播图-->
            ...
            <div class="news">
                <div class="current-new">
                    <c:forEach items="${news}" var="news_list">
                       <div class="current-new-info">
                           <img src="${CTP_HOME}/img/dot.png" />
                           <a href="${CTP}/details/trends?id=${news_list.id}&flag=${newsFlag}" target="_blank" title="${news_list.itemTitle}">${news_list.itemTitle}</a>
                           <span class="data-sub pub-data">[${news_list.addTime}]</span>
                           <img src="${CTP_HOME}/img/hot.gif" />
                       </div>
                    </c:forEach>
                ...
                <div class="roll-new-info-list">
                    <ul>
                        <c:forEach items="${notice}" var="notice">
                            <li>
                                <img src="${CTP_HOME}/img/dot.png"/>
                                <a href="${CTP}/details/trends?id=${notice.id}&flag=${noticeFlag}">${notice.itemTitle}</a>
                                <span class="pub-data sub-time">[<fmt:formatDate value="${notice.addTime}" pattern="yyyy-MM-dd"/>]</span>
                                <img src="${CTP_HOME}/img/hot.gif"/>
                            </li>
                        </c:forEach>
                    </ul>
        ...
        <div class="even-bg sunshine-bg">
            <div class="content-div sunshine">
                <div class="trends-top sunshine-trends-top">
                    <img src="${CTP_HOME}/img/sun.png"/> 
                    <span class="tag-ch">阳光德育</span>
                    <span class="tag-en">Sunshine moral education</span>
                    <a class="link-tag" href="${CTP}/category/education">进入>></a>
                </div>
                <!--S 轮播图-->
                <div class="slider-sunshine slide-s">
                    <ul>
                        <c:forEach items="${sildeEdu}" var="s_list">  
                            <li class="slider-li">
                                <a href="${CTP}/details/education?id=${s_list.id}&flag=${s_list.itemTypeFlag}" target="_blank" ><img lay-src="${s_list.imagePath}" alt="${s_list.itemTitle}"  /></a>
                            </li>
                        </c:forEach>
                           ...
                           <div>
                             <ul>
                                <c:forEach items="${education}"  var="education_list">
                                  <li>
                                    <img src="${CTP_HOME}/img/sjiantou.png"/>
                                    <a href="${CTP}/details/education?id=${education_list.id}&flag=${educationFlag}" title="${education_list.itemTitle}">${myTag:substr(education_list.itemTitle,0,35,true)}</a>
                                    <span class="pub-data sub-time">[<fmt:formatDate value="${education_list.addTime}" pattern="yyyy-MM-dd"/>]</span>
                                  </li>
                              </c:forEach>
                             </ul>
                           </div>
        ...
        <div class="student-site">
            <div class="trends-top student-trends-top">
                <img src="${CTP_HOME}/img/stu-site.png"/>
                <span class="tag-ch">学生天地</span>
                <span class="tag-en">The world of students</span>
                <a class="link-tag" href="${CTP}/category/student">进入>></a>
            </div>
            <!--S 轮播图-->
            <div class="slider-sunshine slide-s">
                <ul>
                    <c:forEach items="${slideStudent}" var="s_list">
                        <%-- Fix bug : ${CTP}/details/${CTP}/details --%>
                        <li class="slider-li">
                            <a href="${CTP}/details/student?id=${s_list.id}&flag=${s_list.itemTypeFlag}" target="_blank" ><img lay-src="${s_list.imagePath}" alt="${s_list.itemTitle}"  /></a>
                        </li>
                    </c:forEach>
                       ...
                       <div>
                         <ul>
                           <c:forEach items="${student}" var="student_list">
                             <li>
                               <img src="${CTP_HOME}/img/sjiantou.png"/>
                               <a href="${CTP}/details/student?id=${student_list.id}&flag=${studentFlag}" title="${student_list.itemTitle}">${myTag:substr(student_list.itemTitle,0,35,true)}</a>
                               <span class="pub-data sub-time">[<fmt:formatDate value="${student_list.addTime}" pattern="yyyy-MM-dd"/>]</span>
                             </li>
                           </c:forEach>
                        </ul>
                       </div>
        ...
        <div class="even-bg teacher-bg">
            <div class="content-div sunshine">
                <div class="trends-top sunshine-trends-top">
                    <img src="${CTP_HOME}/img/teacher.png"/>
                    <span class="tag-ch">教师园地</span>
                    <span class="tag-en">The teachers' corner</span>
                    <a class="link-tag" href="${CTP}/category/teacher">进入>></a>
                </div>
                <!--S 轮播图-->
                <div class="slider-sunshine slide-s">
                    <ul>
                        <c:forEach items="${slideTeacher}" var="s_list">
                            <li class="slider-li">
                                <a href="${CTP}/details/${CTP}/details/teacher?id=${s_list.id}&flag=teachers" target="_blank" ><img lay-src="${s_list.imagePath}" alt="${s_list.itemTitle}" /></a>
                            </li>
                        </c:forEach>
                           ...
                           <div>
                             <ul>
                               <c:forEach items="${teacher}" var ="teacher_list">
                                 <li>
                                   <img src="${CTP_HOME}/img/sjiantou.png"/>
                                   <a href="${CTP}/details/teachingResources?menuId=${teacher_list.menuId}&classId=${teacher_list.classId}&tid=${teacher_list.id}&flag=${teacher_list.itemTypeFlag}"  title="${teacher_list.itemTitle}">${myTag:substr(teacher_list.itemTitle,0,35,true)}</a>
                                   <span class="pub-data ">[${teacher_list.addTime}]</span>
                                 </li>
                               </c:forEach>
                             </ul>
                           </div>
        ...
        <div class="school-dang">
            ...
            <div class="school-div">
                <div class="trends-top school-trends-top">
                    <img src="${CTP_HOME}/img/school.png"/>
                    <span class="tag-ch">学校管理</span>
                    <span class="tag-en">Administration</span>
                    <a class="link-tag" href="${CTP}/category/manage">进入>></a>
                </div>
                <!--tab-->
                           ...
                           <div>
                              <ul>
                                <c:forEach items="${deptContent}" var="deptContent">
                                  <li>
                                    <img src="${CTP_HOME}/img/sjiantou.png"/>
                                    <a href="${CTP}/details/departmentLink?contentId=${deptContent.id}&departmentId=${deptContent.departmentId}&contentFlag=${deptContent.typeId}"  title="${deptContent.itemTitle}">${myTag:substr(deptContent.itemTitle,0,27,true)}</a>
                                    <span class="pub-data sub-time">[${myTag:datesub(deptContent.addTime)}]</span>
                                  </li>
                                </c:forEach>
                              </ul>
                           </div>
            ...
            <!--S 党务工会-->
            <div class="dang-div">
                <div class="trends-top dang-trends-top">
                    <img src="${CTP_HOME}/img/dang.png"/>
                    <span class="tag-ch">党务工会</span>
                    <span class="tag-en">The Party Union</span>
                    <a class="link-tag" href="${CTP}/category/party">进入>></a>
                </div>
                <!--tab-->
                <div class="tab-container school-container">
                    <div class="tab">

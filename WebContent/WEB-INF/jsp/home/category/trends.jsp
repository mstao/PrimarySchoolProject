		...
		<div class="top-contaner-right clearfix">
			...
			<div class="top-center">
				 ...
				 <!--S 轮播图-->
					...
					<c:forEach items="${slideNews}" var="s_list">  
						<li class="slider-li"><a href="${CTP}/details/trends?id=${s_list.id}&flag=${s_list.itemTypeFlag}" target="_blank" ><img src="${s_list.imagePath}" alt="${s_list.itemTitle}"  /></a></li>
					</c:forEach>	
				     <c:if test="${empty slideNews}">

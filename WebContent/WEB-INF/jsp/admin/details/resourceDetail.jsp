		...
		if(title=="" || text_content=="" ||publish_dept==""){
  		...
  		var is_publish=1; //意味着要发表1，不是存为草稿0
			$.ajax({
				...
				data:{"id":nid,"itemTitle":title,"itemContent":content,"menuId":"${menuId}","classId":"${classId}","typeFlag":type,"author":publish_dept,"isImage":is_image,"isPublish":is_publish,"addTime":date_picker},

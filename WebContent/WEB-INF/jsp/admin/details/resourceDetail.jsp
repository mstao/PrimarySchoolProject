...
<jsp:include page="../../common/browsehappy.jsp"></jsp:include>
	...
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">修改${menuName}
	...
	<div class="check-zone">
		...
		<div class="options-checked-div" id="s">
			...
			<input type="text" name="publish_dept" class="publish-dept" value="${item.author }">
		    <br>
...
$(function(){
  ...
  $('.publish-trends-btn').bind('click',function(){
		...
		if(title=="" || text_content=="" ||publish_dept==""){
			...
			s_json={"id":nid,"itemTitle":title,"itemContent":content,"menuId":"${menuId}","classId":"${classId}","typeFlag":type,"author":publish_dept,"isImage":is_image,"isPublish":is_publish,"addTime":date_picker,"imagePath":img_path};

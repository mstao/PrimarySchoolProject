...
<jsp:include page="../../common/browsehappy.jsp"></jsp:include>
	...
	<!--S 编辑区域-->
	<div class="edit-div"> 
		<span class="edit-span">${labName }>修改${menuName}
	...
	<div class="check-zone">
		...
		<div class="options-checked-div" id="s">
		    ...
		    <c:choose>
		    	<c:when test="${durl == url}">
					    <c:set var="intro" value="intro"></c:set>
					     <c:forEach var="type" items="${resouceType }">
					     <c:choose>
						     	<c:when test="${type.itemTypeFlag == intro }"></c:when>
						     	<c:when test="${type.itemTypeName == menuName }">

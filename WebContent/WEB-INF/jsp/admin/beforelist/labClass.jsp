...
<div id="location"><span>您现在的位置: 后台管理 ></span><span>${SCHOOL_STUDENT_LAB }</span></div>
	...
	<!--s 操作-->
    	<div class="operation">
                ...
                <input type="text" class="new_text" placeholder="请输入您想添加的社团" value="" name="keywords" /> 
    ...
    <div class="contents">
    	...
    	<span><input type="checkbox" name="info_id" value="${labClass.id}"/><a href="${CTP}/admin/list/labclassinfo?labId=${labClass.id}&p=1">${labClass.labName}</a></span>
    	</c:forEach>
    	<br><br>
    	</div>
    	<!--e class-info-->

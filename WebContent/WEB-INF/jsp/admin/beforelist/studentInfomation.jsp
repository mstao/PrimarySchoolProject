...
<div id="location"><span>您现在的位置: 后台管理 ></span><span>${SCHOOL_STUDENT_INFOMATION }</span></div>
    ...
    <div class="class-content">
    	...
    	<div class="class-content-only">
    		...
    		<c:if test="${sclass.gradeCode==grade.gradeCode }">
    			...
    			<span><a href="${CTP }/admin/list/stuInfo?classId=${sclass.id }&fullName=${fullName }&p=1">${fullName }</a></span>
    		</c:if>
    		</c:forEach>
    		</div>
    	</div>

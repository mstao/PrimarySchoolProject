  ...
  $('.publish-trends-btn').bind('click',function(){
		...
		if(title=="" || text_content=="" ||publish_dept==""){
			...
			if(editor.$txt.find("img[src!='']").length>0){
  		    ...
  		    s_json={"itemTitle":title,"itemContent":content,"menuId":"${menuId}","classId":"${classId}","typeFlag":type,"author":publish_dept,"isImage":is_image,"isPublish":is_publish,"addTime":date_picker,"imagePath":img_path};

...
<jsp:include page="../../common/browsehappy.jsp"></jsp:include>
	...
	<div class="edit-div"> 
		...
		<span class="content-span">${labName}内容</span><br>
		 <!--S 编辑器 -->              
	...
	<div class="check-zone">
		...
		<div class="options-checked-div" id="s">
		    ...
		    <select name="publish_style" id="publish-style">
			    ...
			    <c:if test="${type.itemTypeFlag != intro}">
...
$(function(){
  ...
  $('.publish-trends-btn').bind('click',function(){
		...
		if(title=="" || text_content=="" ||publish_dept==""){
			...
			s_json={"itemTitle":title,"itemContent":content,"labId":"${labId}","typeFlag":type,"author":publish_dept,"isImage":is_image,"isPublish":is_publish,"addTime":date_picker,"imagePath":img_path};

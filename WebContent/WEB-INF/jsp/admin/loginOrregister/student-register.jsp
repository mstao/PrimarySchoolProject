	...
	<div id="rights">
			...
			<section id="content">
				<form action="">
					<h1>注册</h1>
				<div>
					<input type="text" placeholder="请输入学生真实姓名" required="" id="username" />
				</div>
				<div>
					<input type="text" placeholder="请输入学生身份证号" required="" id="number" />
				</div>
				<div>
				...
				<div>
					...
					<div>
						...
						<a href="${CTP}/admin/loginRegister/showStuLogin">登录</a>
					</div>
				</form><!-- form -->
				<div class="button">
					<a href="#">返回主页</a>

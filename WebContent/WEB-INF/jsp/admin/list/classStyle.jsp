      				...
      				$.ajax({
						...
						success:function(data){
							...
							if(data==1){
								...
								window.location.href="${pageContext.request.contextPath}/admin/list/${url}?classId=${classId}";
...
<jsp:include page="../../common/browsehappy.jsp"></jsp:include>
	...
	<!--S main-->
            <div class="new_div1"><span class="new_div1_span">${className}-班级风采-列表</span><a href="${CTP}/admin/write/${url}?classId=${classId}" class="add_list">新增</a></div>
            <div class="main-div">
           
            <c:forEach items="${style}" var="list">
